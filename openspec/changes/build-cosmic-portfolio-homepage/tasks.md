...
- [x] 4.4 補上社群分享圖與正式 favicon 等站點品牌素材
...
- [x] 7.1 將作品資料的外部連結欄位統一為單一 `link` 字串格式
- [x] 7.2 依 `project-link.json` 同步補齊履歷與擴充作品資料中的對應連結
- [x] 7.3 修正首頁精選作品 CTA，讓它直接使用專案外部連結而非覆寫為 `/projects` 錨點
